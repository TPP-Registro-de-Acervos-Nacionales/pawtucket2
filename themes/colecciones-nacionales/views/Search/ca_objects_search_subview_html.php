...
?>
				<span class='multisearchFullResults'><?php print caNavLink($this->request, '<span class="glyphicon glyphicon-list"></span> '._t('Resultados'), '', '', 'Búsqueda', '{{{block}}}', array('search' => str_replace("/", "", $vs_search))); ?></span> |
<?php
				}
?>

				<span class='multisearchSort'><?php print _t("Ordenar por:"); ?> {{{sortByControl}}}</span>
