...
<body>
	...
	<?php
					print caNavLink($this->request, caGetThemeGraphic($this->request, '8G7v2ZKS1qulZl7OKlkj_4a7m5CoBW144gfT7.jpeg'), "navbar-brand logo", "", "","");
	?>
				</div>
					...
					<form class="navbar-form navbar-right" role="search" action="<?php print caNavUrl($this->request, '', 'MultiSearch', 'Index'); ?>">
						<div class="formOutline">
							<div class="form-group">
								<input type="text" class="form-control" id="headerSearchInput" placeholder="Buscar..." name="search" autocomplete="off" />
							</div>
					...
					<script type="text/javascript">
						$(document).ready(function(){
							...
							$('#headerSearchInput').on('keyup', function(){
								$('#headerSearchButton').prop('disabled', this.value === "");
							})
						});
					</script>
